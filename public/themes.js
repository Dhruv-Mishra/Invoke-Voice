...
const defaultTokens = {
  ...
  '--cp-caption-min-width': '156px',
  '--cp-caption-max-height': 'min(126px, 16dvh)',
  '--cp-caption-speaker-offset': '0px',
  '--cp-caption-stack-gap': '6px',
  '--cp-caption-padding': '8px',
  '--cp-caption-radius': '14px',
  '--cp-caption-blur': '14px',
  '--cp-caption-control-size': '28px',
  '--cp-caption-assistant-bg': 'linear-gradient(135deg, rgba(174, 48, 221, 0.72), rgba(235, 64, 164, 0.72) 58%, rgba(255, 126, 108, 0.72))',
  '--cp-caption-assistant-bg-solid': 'linear-gradient(135deg, #ae30dd, #eb40a4 58%, #ff7e6c)',
  '--cp-caption-user-bg': 'linear-gradient(135deg, rgba(13, 169, 242, 0.72), rgba(28, 111, 220, 0.72) 58%, rgba(35, 66, 190, 0.72))',
